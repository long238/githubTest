...
Module {
    ...
    property stringList config: ["shared","shared","debug_and_release","debug","release","build_all","c++11","c++14","c++1z","concurrent","dbus","no-pkg-config","stl"]
    property stringList qtConfig: ["shared","shared","debug_and_release","debug","release","build_all","c++11","c++14","c++1z","concurrent","dbus","no-pkg-config","stl"]
    property path binPath: "D:/QT/5.14.1/msvc2017_64/bin"
    property path incPath: "D:/QT/5.14.1/msvc2017_64/include"
    property path libPath: "D:/QT/5.14.1/msvc2017_64/lib"
    property path pluginPath: "D:/QT/5.14.1/msvc2017_64/plugins"
    property string mkspecName: "win32-msvc"
    property path mkspecPath: "D:/QT/5.14.1/msvc2017_64/mkspecs/win32-msvc"
    ...
    property path docPath: "D:/QT/Docs/Qt-5.14.1"
    ...
    property string libFilePathDebug: "D:/QT/5.14.1/msvc2017_64/lib/Qt5Cored.lib"
    property string libFilePathRelease: "D:/QT/5.14.1/msvc2017_64/lib/Qt5Core.lib"
    ...
    property stringList moduleConfig: ["lex","yacc","exceptions","depend_includepath","testcase_targets","import_plugins","import_qpa_plugin","windows","qt_build_extra","file_copies","qmake_use","qt","warn_on","release","link_prl","flat","debug_and_release","precompile_header","autogen_precompile_source","embed_manifest_dll","embed_manifest_exe","shared","shared","release","no_plugin_manifest","win32","msvc","copy_dir_files","sse2","aesni","sse3","ssse3","sse4_1","sse4_2","avx","avx2","avx512f","avx512bw","avx512cd","avx512dq","avx512er","avx512ifma","avx512pf","avx512vbmi","avx512vl","compile_examples","f16c","force_debug_info","largefile","precompile_header","rdrnd","shani","x86SimdAlways","prefix_build","force_independent","utf8_source","create_prl","link_prl","prepare_docs","qt_docs_targets","no_private_qt_headers_warning","QTDIR_build","qt_example_installs","testcase_exceptions","warning_clean","release","ReleaseBuild","Release","build_pass","c++11","exceptions","qt_tracepoints","moc","resources","simd","optimize_full","pcre2","generated_privates","relative_qt_rpath","git_build","target_qt","c++11","strict_c++","c++14","c++1z","qt_install_headers","need_fwd_pri","qt_install_module","debug_and_release","build_all","create_cmake","skip_target_version_ext","release","ReleaseBuild","Release","build_pass","have_target","dll","exclusive_builds","debug_info","no_autoqmake","arch_haswell","avx512common","avx512core","thread"]
    Properties {
    ...
    cpp.includePaths: {
        var paths = ["D:/QT/5.14.1/msvc2017_64/include","D:/QT/5.14.1/msvc2017_64/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib","D:/QT/5.14.1/msvc2017_64/lib/qtmaind.lib"] : ["Shell32.lib","D:/QT/5.14.1/msvc2017_64/lib/qtmain.lib"]);
        }
