...
QT_MOC_LITERAL(1, 9, 7), // "requset"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 1), // "s"
QT_MOC_LITERAL(4, 20, 10) // "comReceive"

    },
    "MyThread\0requset\0\0s\0comReceive"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requset((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->comReceive(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::requset)) {
                *result = 0;
            }
        }
        {
            typedef void (MyThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::comReceive)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void MyThread::requset(const QString & _t1)
{
